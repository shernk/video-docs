...
class AppComponent {
    constructor(titleService, offlineOnlineService) {
...
const ɵ0 = () => __webpack_require__.e(/*! import() | views-home-home-module-ngfactory */ "views-home-home-module-ngfactory").then(__webpack_require__.bind(null, /*! ./views/home/home.module.ngfactory */ "./src/app/views/home/home.module.ngfactory.js")).then(module => module.HomeModuleNgFactory), ɵ1 = () => __webpack_require__.e(/*! import() | views-category-category-module-ngfactory */ "views-category-category-module-ngfactory").then(__webpack_require__.bind(null, /*! ./views/category/category.module.ngfactory */ "./src/app/views/category/category.module.ngfactory.js")).then(module => module.CategoryModuleNgFactory), ɵ2 = () => __webpack_require__.e(/*! import() | views-about-about-module-ngfactory */ "views-about-about-module-ngfactory").then(__webpack_require__.bind(null, /*! ./views/about/about.module.ngfactory */ "./src/app/views/about/about.module.ngfactory.js")).then(module => module.AboutModuleNgFactory), ɵ3 = () => __webpack_require__.e(/*! import() | views-contact-contact-module-ngfactory */ "views-contact-contact-module-ngfactory").then(__webpack_require__.bind(null, /*! ./views/contact/contact.module.ngfactory */ "./src/app/views/contact/contact.module.ngfactory.js")).then(module => module.ContactModuleNgFactory);
/**
...
/* harmony import */ var _ng_toolkit_universal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ng-toolkit/universal */ "./node_modules/@ng-toolkit/universal/fesm2015/ng-toolkit-universal.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
class AlertComponent {
    constructor(alertService, localStorage) {
    ...
    ngOnInit() {
        this.alertService.alertSubject.asObservable().subscribe(data => {
            this.alert = new _models_alert_model__WEBPACK_IMPORTED_MODULE_2__["Alert"](data);
            this.isNeeded = true;
        });
    }
    close() {
...
class Alert {
    constructor(data) {
        const defaults = Object.assign({ title: '', content: '' }, data);
...
/* harmony import */ var _alocal_storage_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alocal-storage.model */ "./src/app/components/alert/services/local-storage/alocal-storage.model.ts");

class LocalStorage extends _alocal_storage_model__WEBPACK_IMPORTED_MODULE_0__["ALocalStorage"] {
    getItem(key) {
...
class OfflineOnlineService {
    constructor(alertService, window, platformId) {
        this.alertService = alertService;
        this.window = window;
    ...
    onlineSubscription() {
        this.onlineEvent.subscribe(e => {
            const onlineAlert = new src_app_components_alert_models_alert_model__WEBPACK_IMPORTED_MODULE_0__["Alert"]({ type: _components_alert_models_enums_alert_types_enum__WEBPACK_IMPORTED_MODULE_1__["AlertTypes"].Success, title: 'Online', content: 'Application back online', key: null });
            this.alertService.callAlert(onlineAlert);
        });
    }
    offlineSubscription() {
        this.offlineEvent.subscribe(e => {
            const onlineAlert = new src_app_components_alert_models_alert_model__WEBPACK_IMPORTED_MODULE_0__["Alert"]({ type: _components_alert_models_enums_alert_types_enum__WEBPACK_IMPORTED_MODULE_1__["AlertTypes"].Error, title: 'Offline', content: 'Application went offline', key: null });
            this.alertService.callAlert(onlineAlert);
        });
    }
}
...
class TitleService {
    ...
    updateTitle(navigation) {
        const urlPieces = navigation.url
            .split("/")
     ...
     */
    setTitlePage(urlPiece) {
        const capitalizeTitlePage = `${urlPiece[0][0].toUpperCase()}${urlPiece[0].slice(1)} - Video Dev Docs | VDD`;
...
class SeoService {
    ...
    addTwitterMeta(content, imageUrl) {
...
class HomeComponent {
    ...
    addMetaTags() {
        const descriptionContent = "VideoDevDocs is video based documentation for learning, testing, training developers of all skill sets.";
